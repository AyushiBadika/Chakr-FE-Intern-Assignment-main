...
import { ThemeProvider } from "./settings/appearance/themeProvider";
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body className=" w-full h-{100vh} flex pl-3 pt-8">
        <ThemeProvider
          attribute="class"
          defaultTheme="system"
          enableSystem
        ...
        >
          <ContextWrapper>
            <Command className="w-1/5 h-[100vh]  p-2">
            ...
            <div
              className="w-[80%]  h-[92%] mr-10  p-4 rounded-md "
              ref={toggleRef}
            >
              {children}
            </div>
